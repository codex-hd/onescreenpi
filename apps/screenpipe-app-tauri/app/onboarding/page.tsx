...
import PrivacyWalkthrough from "@/components/onboarding/privacy-walkthrough";
...
type SlideKey = "login" | "permissions" | "engine" | "privacy" | "pipe";
      ...
      <div className="flex-1 flex items-center justify-center p-6 overflow-auto">
        ...
        >
          ...
          {currentSlide === "privacy" && (
            <PrivacyWalkthrough handleNextSlide={handleNextSlide} />
          )}

...
pub async fn stop_screenpipe(
    ...
    stop_screenpipe_internal(&*state).await
}

pub async fn stop_screenpipe_internal(state: &RecordingState) -> Result<(), String> {
...
pub async fn spawn_screenpipe(
    ...
    spawn_screenpipe_internal(&*state, app, _override_args).await
}

pub async fn spawn_screenpipe_internal(

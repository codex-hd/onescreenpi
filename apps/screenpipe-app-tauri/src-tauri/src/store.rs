...
pub struct SettingsStore {
    ...
    /// User-intended capture mode used by tray controls and persistent trust UI.
    #[serde(rename = "captureMode", default = "default_capture_mode")]
    pub capture_mode: String,

    /// ISO timestamp for automatic resume when capture is paused temporarily.
    #[serde(rename = "capturePausedUntil", default)]

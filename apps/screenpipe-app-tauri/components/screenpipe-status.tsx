...
const HealthStatus = ({ className }: { className?: string }) => {
  ...
  const handleRestartServer = async () => {
    ...
    try {
      toast({
        ...
        description: "stopping OneScreenPI server...",
        duration: 3000,
      });
      ...
      toast({
        title: "restarting server",
        description: "starting OneScreenPI server...",
        duration: 3000,
      });
      ...
      toast({
        ...
        description: "OneScreenPI server has been restarted successfully.",
        duration: 3000,
      });
    } catch (error) {
      ...
      toast({
        ...
        description: "failed to restart OneScreenPI server. please check the logs.",
        variant: "destructive",
        duration: 5000,
      });
    } finally {
  ...
  const getStatusMessage = (
    ...
    if (status === "loading")
      return "OneScreenPI is starting up. this may take a few minutes...";
    ...
    if (issues.length === 0) return "OneScreenPI is running smoothly";
      ...
      <Dialog open={isOpen} onOpenChange={close}>
        ...
        >
          <DialogHeader className="flex flex-row items-center justify-between">
            <DialogTitle>OneScreenPI status</DialogTitle>
                ...
                <div className="flex items-center gap-3 p-4 bg-destructive/10 border border-destructive/20 rounded-lg">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-destructive">
                      OneScreenPI server is not running
                    </p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground mb-4">
                          ensure OneScreenPI has the necessary permissions to function properly
                        </p>

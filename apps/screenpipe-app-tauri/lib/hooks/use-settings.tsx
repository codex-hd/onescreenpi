...
export type Settings = SettingsStore & {
	...
	/** Explicit consent gate for AI assistants reading captured local history */
	...
	/** User-intended capture mode shared with tray controls */
	captureMode?: "running" | "paused" | "stopped";
	/** Auto-resume timestamp when capture is temporarily paused */

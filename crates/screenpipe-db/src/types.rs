...
pub struct MemoryItemRecord {
    ...
    pub display_id: Option<String>,
    pub os_user_id: Option<String>,
    pub is_private_window: i64,
    pub is_user_deleted: i64,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct NewMemoryTextSegment {
    pub id: String,
    pub memory_item_id: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, FromRow)]
pub struct MemoryTextSegmentRecord {
    pub id: String,
    pub memory_item_id: String,
    pub source_kind: String,
    pub language_code: Option<String>,
...
pub struct MemoryItemSearchFilters {
...
#[derive(Debug, Clone, Serialize, Deserialize, FromRow)]
pub struct MemoryItemSearchResult {
    pub memory_item_id: String,
    pub session_id: Option<String>,
    pub occurred_at_ms: i64,
    pub captured_at_ms: i64,
    ...
    pub retention_bucket: String,
    pub content_hash: Option<String>,
    pub asset_relative_path: Option<String>,
...
pub struct NewRetentionPolicy {
    ...
    pub keep_clipboard_days: Option<i64>,
    pub keep_screenshots_days: Option<i64>,
    pub purge_excluded_immediately: bool,
    pub created_at_ms: i64,
    pub updated_at_ms: i64,
}
...
pub struct RetentionPolicyRecord {
    ...
    pub keep_clipboard_days: Option<i64>,
    pub keep_screenshots_days: Option<i64>,
    pub purge_excluded_immediately: i64,
    pub created_at_ms: i64,
    pub updated_at_ms: i64,
}
...
pub struct RetentionCleanupPolicy {
    pub keep_screenshots_days: i64,
    pub keep_clipboard_days: i64,
    pub purge_excluded_immediately: bool,
}

#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct DeletionJobFilter {
    #[serde(default)]
    ...
    pub url_domain: Option<String>,
    pub item_type: Option<String>,
    pub retention: Option<RetentionCleanupPolicy>,
}
...
#[derive(Debug, Clone, Serialize, Deserialize, FromRow)]
pub struct MemoryDeletionCandidate {
    pub id: String,
    pub item_type: String,
    pub occurred_at_ms: i64,
    pub source_app_id: Option<String>,
...
#[derive(Debug, Clone, Serialize, Deserialize, FromRow)]
pub struct MemoryAssetDeleteCandidate {
    pub item_id: String,
    pub relative_path: String,
}

#[derive(Debug, Clone, Serialize, Deserialize, Default)]
pub struct HardDeleteBatchResult {
    pub deleted_items: u64,
    pub deleted_assets: u64,
}
